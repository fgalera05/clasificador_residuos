...
def puntos_cercanos(lat, lon, df_puntos_verdes, radio_km=0.3):
    """Retorna los puntos verdes dentro del radio (km) indicado, ordenados por distancia."""
    ...
    cerca = df[df["_dist"] <= radio_km].sort_values("_dist")
